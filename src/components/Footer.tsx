     ...
     return (
        <>
            <div className='border-t-1  border-t-[#94A3B8] mt-20 mb-8 '>
                <div className=' container mx-auto p-4 mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4'>
                    <div className='grid text-[#475569] gap-5 col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-2'>
                    ...
                    <div className='grid text-[#475569] gap-2'>
